...
const ForgotPassword: FunctionComponent<ForgotPasswordProps> = () => {
    ...
    const formik1 = useFormik({
        ...
        onSubmit: async (values: any) => {
            const user: any = await feedbackService.promiseToast(userService.getUserByEmail, "", values.email);
    ...
    const formik2 = useFormik({
        ...
        onSubmit: async (values: any) => {
            ...
            await feedbackService.promiseToast(userService.updateUserPassword, "", data);
        },
    });
